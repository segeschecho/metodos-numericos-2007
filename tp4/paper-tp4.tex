...
\caption{ Aqui se puede apreciar un caso patológico para el promedio, bien resuelto por el método de la mayor distancia}
\end{figure}
...
\caption{ En este caso, la mayor distancia no funciona, pero el centro es capturado por la tecnica de las mediatrices}
\end{figure}
...
\caption{ Este es otro caso patológico para las mediatrices, el método de la mayor distancia lo tratría correctamente}
\end{figure}
