...
\centerline{\scriptsize Prueba 1}
\centerline{\includegraphics[scale=0.5]{prueba1-a.jpg}}

{\includegraphics[scale=0.45]{prueba1-b.jpg}}{\includegraphics[scale=0.5]{prueba1-c.jpg}}

\pagebreak
\centerline{\scriptsize Prueba 2}
\centerline{\includegraphics[scale=0.5]{prueba2-a.jpg}}

{\includegraphics[scale=0.5]{prueba2-b.jpg}}

{\includegraphics[scale=0.5]{prueba2-c.jpg}}

\pagebreak
\centerline{\scriptsize Prueba 3}
\centerline{\includegraphics[scale=0.5]{prueba3-a.jpg}}

{\includegraphics[scale=0.5]{prueba3-b.jpg}}

{\includegraphics[scale=0.5]{prueba3-c.jpg}}

\pagebreak
\centerline{\scriptsize Prueba 4}
\centerline{\includegraphics[scale=0.5]{prueba4-a.jpg}}

{\includegraphics[scale=0.5]{prueba4-b.jpg}}

{\includegraphics[scale=0.5]{prueba4-c.jpg}}

\pagebreak
\centerline{\scriptsize Prueba 5}
\centerline{\includegraphics[scale=0.5]{prueba5-a.jpg}}

{\includegraphics[scale=0.5]{prueba5-b.jpg}}

{\includegraphics[scale=0.5]{prueba5-c.jpg}}
\pagebreak
En estos gr\'aficos se puede visualizar la temperatura del horno de una manera muy descriptiva. Por ejemplo, podemos ver que el horno de la prueba 4 es el que en mejores condiciones esta, a diferencia de los dem\'as.
