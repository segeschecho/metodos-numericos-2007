...
\item filas() y columnas(): se implementaron sendos métodos para conocer tanto el número de filas como de columnas de la matriz creada. Tan solo devuelven una copia de los atributos privados de la clase.
...
Este método se limita aplicar restarFilas con los elementos de la diagonal, hasta que algún pivote tiene valor cero, momento en el que se emplea pivotear.
...
operator=: copia la variable de la derecha en la de la izquierda y luego libera la memoria correspondiente a la primera. 
\end{itemize}
