...
Al ver los resultados en los gráficos anteriores, algunas de nuestras hipótesis se vieron desmentidas. Por ejemplo mirando en general los gráficos, claramente se ve como en promedio, el mejor algoritmo, el que tiene menor error relativo, es el que calcula 1/e\^{}x. Con respecto a esto estuvimos debatiendo el por qué de este resultado, y llegamos a la conclusión de que se debe a que, la forma e\^{}(-x) es más inestable en los primeros términos, ya que el gráfico del resultado va oscilando entre los positivos y negativos, hasta que comienza a estabilizarse en torno al valor a calcular, para que suceda esto debe haber una cantidad grande de términos, y además mayor precisión. En cambio la forma 1/e\^{}x es más estable, ya que primero se calcula e\^{}x, la cual tiene todos sus términos positivos, por lo que no existe el probléma de que la serie oscile hasta comenzar a obtener el resultado, lo que significa que no se necesitan tantos términos, ni tanta precisión para llegar a el resultado. Si bien al finalizar, luego de calcular e\^{}x, se hace una operación adicional, que es la de elevar a la potencia negativa -1, el error propagado no es tan significativo, a pesar de que se realiza, en los casos extremos, sobre un numero muy grande o muy chico. Por lo dicho consideramos queda claro el por qué del resultado.
